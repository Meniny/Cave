...
- name: "Ezra"
  url: "https://itunes.apple.com/us/app/Ezra-abel/id1098278826?l=zh&ls=1&mt=8"
  desc: "Personal"
  lan: "Swift"
...
- name: "Cave"
  url: "{github}/Cave"
  desc: "📱 The iOS client for Ezra's Cave."
  lan: "Swift"
